...
char ococo::cons_call_no_updates(const pos_stats_uncompr_t &psu,
...
template <typename T, int counter_size, int refbase_size>
int ococo::stats_t<T, counter_size, refbase_size>::load_fasta(
...
template <typename T, int counter_size, int refbase_size>
int ococo::stats_t<T, counter_size, refbase_size>::save_fasta(
...
template <typename T, int counter_size, int refbase_size>
int ococo::stats_t<T, counter_size, refbase_size>::import_stats(
...
template <typename T, int counter_size, int refbase_size>
int ococo::stats_t<T, counter_size, refbase_size>::export_stats(
...
template <typename T, int counter_size, int refbase_size>
int ococo::stats_t<T, counter_size, refbase_size>::call_consensus_position(
...
template <typename T, int counter_size, int refbase_size>
T ococo::stats_t<T, counter_size, refbase_size>::compress_position_stats(
...
template <typename T, int counter_size, int refbase_size>
void ococo::stats_t<T, counter_size, refbase_size>::decompress_position_stats(
...
template <typename T, int counter_size, int refbase_size>
int ococo::stats_t<T, counter_size, refbase_size>::print_vcf_header(
...
template <typename T, int counter_size, int refbase_size>
int ococo::stats_t<T, counter_size, refbase_size>::print_vcf_substitution(
...
template <typename T, int counter_size, int refbase_size>
int ococo::stats_t<T, counter_size, refbase_size>::print_pileup_line(
...
template <typename T, int counter_size, int refbase_size>
std::string ococo::stats_t<T, counter_size, refbase_size>::debug_str_counters(
...
template <typename T, int counter_size, int refbase_size>
void ococo::stats_t<T, counter_size, refbase_size>::debug_print_counters()
    const {
    for (int seqid = 0; seqid < n_seqs; seqid++) {
        fprintf(stderr, "%s\n", seq_name[seqid]);
        for (int64_t pos = 0; pos < seq_len[seqid]; pos++) {
...
template <typename T, int counter_size, int refbase_size>
inline int ococo::stats_t<T, counter_size, refbase_size>::set_nucl_nt256(
...
template <typename T, int counter_size, int refbase_size>
inline int ococo::stats_t<T, counter_size, refbase_size>::get_nucl_nt256(
