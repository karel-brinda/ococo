...
namespace ococo {
	...
	template <typename T, int counter_size, int refbase_size>
		stats_t<T, counter_size, refbase_size>::
		stats_t(ococo::params_t *params, bam_hdr_t &h)
		: n_seqs(h.n_targets),
	...
	template <typename T, int counter_size, int refbase_size>
		int stats_t<T, counter_size, refbase_size>::
		save_fasta( const std::string &fasta_fn) const {
	...
	template <typename T, int counter_size, int refbase_size>
		bool stats_t<T, counter_size, refbase_size>::
		check_allocation() const {
	...
	template <typename T, int counter_size, int refbase_size>
		bool stats_t<T, counter_size, refbase_size>::
		check_headers_bam_hdr(const bam_hdr_t &h) const {
	...
	template <typename T, int counter_size, int refbase_size>
		int stats_t<T, counter_size, refbase_size>::
		import_stats(const std::string &stats_fn) {
	...
	template <typename T, int counter_size, int refbase_size>
		int stats_t<T, counter_size, refbase_size>::
		export_stats(const std::string &stats_fn) const {
	...
	template <typename T, int counter_size, int refbase_size>
		int stats_t<T, counter_size, refbase_size>::
		call_consensus(FILE *vcf_file, FILE *pileup_file) {
			assert(check_allocation());
	...
	template <typename T, int counter_size, int refbase_size>
		int stats_t<T, counter_size, refbase_size>::
		call_consensus_position(FILE *vcf_file, FILE *pileup_file, int32_t seqid, int64_t pos) {
	...
	template <typename T, int counter_size, int refbase_size>
		T stats_t<T, counter_size, refbase_size>::
		compress_position_stats(const pos_stats_uncompr_t &psu) {
	...
	template <typename T, int counter_size, int refbase_size>
		void stats_t<T, counter_size, refbase_size>::
		decompress_position_stats(T psc, pos_stats_uncompr_t &psu) {
	...
	template <typename T, int counter_size, int refbase_size>
		int stats_t<T, counter_size, refbase_size>::
		print_vcf_header(FILE *vcf_file, std::string cmd, std::string fasta) const {
	...
	template <typename T, int counter_size, int refbase_size>
		int stats_t<T, counter_size, refbase_size>::
		print_vcf_substitution(	FILE *vcf_file, int32_t seqid,
				int64_t pos, char old_base, char new_base,
				const pos_stats_uncompr_t &psu) const {
	...
	template <typename T, int counter_size, int refbase_size>
		int stats_t<T, counter_size, refbase_size>::
		print_pileup_line(FILE *pileup_file, int32_t seqid, int64_t pos,
				const pos_stats_uncompr_t &psu) const {
	...
	template <typename T, int counter_size, int refbase_size>
		std::string stats_t<T, counter_size, refbase_size>::
		debug_str_counters(int32_t seqid, int64_t pos) const {
	...
	template <typename T, int counter_size, int refbase_size>
		inline int stats_t<T, counter_size, refbase_size>::
		set_nucl_nt256(int32_t seqid, int64_t pos, const char &nt256) {
	...
	template <typename T, int counter_size, int refbase_size>
		inline int stats_t<T, counter_size, refbase_size>::
		get_nucl_nt256(int32_t seqid, int64_t pos, char &nt256) const {
